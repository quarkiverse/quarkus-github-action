...
runs:
  ...
  steps:
    ...
    - name: Run the action
      id: action
      run: jbang --java 21 --repos 'quarkus-github-action=https://maven.pkg.github.com/gsmet/my-github-action/' --repos 'mavencentral' org.acme:my-github-action:999-SNAPSHOT <8>
      shell: bash
      env:
...
----
    - name: Run the action
      id: action
      run: jbang --java 17 --repos 'quarkus-github-action=https://maven.pkg.github.com/gsmet/my-github-action/' --repos 'mavencentral' org.acme:my-github-action:999-SNAPSHOT <1>
      shell: bash
      env:
